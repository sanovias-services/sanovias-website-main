    ...
    <footer className="bg-[#1C3C47] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="border-t border-gray-600 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p className="font-inter">&copy; {new Date().getFullYear()} Sanovias Medical Tourism. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="font-inter hover:text-[#2CA6A4] transition-colors duration-200">Privacy Policy</Link>
            <Link href="/terms" className="font-inter hover:text-[#2CA6A4] transition-colors duration-200">Terms of Service</Link>
            <Link href="/cookies" className="font-inter hover:text-[#2CA6A4] transition-colors duration-200">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
